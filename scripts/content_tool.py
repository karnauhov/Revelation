...
class TopicContentTool(tk.Tk):
    ...
    def __init__(self, start_dir: Path) -> None:
        ...
        self.topic_icon_var = tk.StringVar()
    ...
    def _set_editor_controls_enabled(self, enabled: bool) -> None:
        ttk_widgets: list[tuple[tk.Widget, bool]] = [
            (self.btn_save, False),
        ...
        for widget, readonly_when_enabled in ttk_widgets:
        ...
        self.texts_list.configure(state="normal" if enabled else "disabled")
        self.markdown_text.configure(state="normal" if enabled else "disabled")
    ...
    def _update_ui_availability(self) -> None:
        ...
        self._set_editor_controls_enabled(has_loaded_db)
    ...
    def _build_topics_tab(self, parent: ttk.Frame) -> None:
        ...
        ttk.Label(right, text="ID иконки:").grid(row=3, column=0, sticky="w", padx=(0, 8), pady=4)
        self.entry_topic_icon = ttk.Entry(right, textvariable=self.topic_icon_var)
        self.entry_topic_icon.grid(row=3, column=1, sticky="ew", pady=4)
    ...
    def _reload_selected_topic(self) -> None:
        ...
        self.topic_icon_var.set(row.id_icon)
    ...
    def _apply_topic_changes(self) -> None:
        ...
        icon = self.topic_icon_var.get().strip()
    ...
    def _confirm_copy_with_enabled_tests(self, routes: list[str]) -> bool:
        ...
        buttons_row.grid(row=1, column=0, pady=(12, 0))
