...
3. **Специальные метки и форматирование**
   ...
   - Если в тексте есть кавычки «» или двойные или любые другие, то используй вместо них всегда обычные одинарные кавычки ''
   - Для украинского апострофа используй его корректный символ ʼ
