      ...
      PrimarySource(
        ...
        pages: [
          model.Page(
            ...
            wordSeparators: [
              PageLine(0.278, 0.121, 0.278, 0.141),
              PageLine(0.382, 0.121, 0.382, 0.141),
              PageLine(0.448, 0.122, 0.448, 0.143),
              PageLine(0.255, 0.188, 0.255, 0.202),
              PageLine(0.362, 0.191, 0.362, 0.205),
              PageLine(0.379, 0.192, 0.379, 0.205),
              PageLine(0.397, 0.192, 0.397, 0.205),
              PageLine(0.257, 0.204, 0.257, 0.214),
              PageLine(0.282, 0.204, 0.282, 0.214),
              PageLine(0.353, 0.205, 0.353, 0.216),
              PageLine(0.397, 0.205, 0.397, 0.216),
              PageLine(0.256, 0.217, 0.256, 0.228),
              PageLine(0.267, 0.217, 0.267, 0.228),
              PageLine(0.289, 0.216, 0.289, 0.226),
              PageLine(0.336, 0.216, 0.336, 0.226),
              ...
              PageLine(0.333, 0.229, 0.333, 0.239),
              PageLine(0.343, 0.229, 0.343, 0.239),
              PageLine(0.369, 0.23, 0.369, 0.24),
              PageLine(0.315, 0.24, 0.315, 0.251),
              PageLine(0.337, 0.241, 0.337, 0.253),
              PageLine(0.382, 0.241, 0.382, 0.253),
              PageLine(0.256, 0.254, 0.256, 0.264),
              PageLine(0.284, 0.254, 0.284, 0.264),
              PageLine(0.378, 0.255, 0.378, 0.266),
              PageLine(0.342, 0.266, 0.342, 0.278),
              PageLine(0.367, 0.266, 0.367, 0.278),
              PageLine(0.393, 0.267, 0.393, 0.279),
              PageLine(0.254, 0.279, 0.254, 0.291),
              PageLine(0.319, 0.279, 0.319, 0.291),
              PageLine(0.375, 0.281, 0.375, 0.291),
              PageLine(0.393, 0.281, 0.393, 0.291),
              PageLine(0.253, 0.291, 0.253, 0.301),
              PageLine(0.308, 0.291, 0.308, 0.301),
              PageLine(0.361, 0.293, 0.361, 0.303),
              PageLine(0.284, 0.305, 0.284, 0.314),
              PageLine(0.305, 0.305, 0.305, 0.314),
              PageLine(0.283, 0.317, 0.283, 0.327),
              PageLine(0.317, 0.317, 0.317, 0.327),
              PageLine(0.368, 0.318, 0.368, 0.328),
              PageLine(0.392, 0.318, 0.392, 0.328),
              PageLine(0.254, 0.327, 0.254, 0.341),
              PageLine(0.276, 0.327, 0.276, 0.341),
              PageLine(0.302, 0.33, 0.302, 0.34),
              PageLine(0.34, 0.33, 0.34, 0.34),
              PageLine(0.29, 0.341, 0.29, 0.354),
              PageLine(0.309, 0.341, 0.309, 0.354),
              PageLine(0.335, 0.342, 0.335, 0.352),
              PageLine(0.367, 0.342, 0.367, 0.352),
              PageLine(0.392, 0.342, 0.392, 0.353),
              PageLine(0.248, 0.354, 0.248, 0.365),
              PageLine(0.328, 0.354, 0.328, 0.365),
              PageLine(0.339, 0.354, 0.339, 0.366),
              PageLine(0.331, 0.367, 0.331, 0.376),
              PageLine(0.358, 0.367, 0.358, 0.376),
              PageLine(0.374, 0.367, 0.374, 0.377),
              PageLine(0.341, 0.378, 0.341, 0.389),
              PageLine(0.375, 0.378, 0.375, 0.389),
              PageLine(0.286, 0.39, 0.286, 0.399),
              PageLine(0.321, 0.39, 0.321, 0.399),
              PageLine(0.273, 0.401, 0.273, 0.411),
              PageLine(0.301, 0.401, 0.301, 0.411),
              PageLine(0.39, 0.401, 0.39, 0.412),
              PageLine(0.248, 0.413, 0.248, 0.424),
              PageLine(0.272, 0.413, 0.272, 0.424),
              PageLine(0.294, 0.412, 0.294, 0.423),
              PageLine(0.34, 0.412, 0.34, 0.423),
              PageLine(0.303, 0.425, 0.303, 0.437),
              PageLine(0.316, 0.425, 0.316, 0.437),
              PageLine(0.344, 0.425, 0.344, 0.437),
              PageLine(0.39, 0.425, 0.39, 0.437),
              PageLine(0.253, 0.438, 0.253, 0.447),
              PageLine(0.302, 0.438, 0.302, 0.447),
            ],
            strongNumbers: [
              PageLabel("602", 0.335, 0.122),
              PageLabel("2491", 0.416, 0.123),
              PageLabel("602", 0.310, 0.188),
              PageLabel("2424", 0.37, 0.188),
              PageLabel("5547", 0.388, 0.189),
              PageLabel("3739", 0.269, 0.203),
              PageLabel("1325", 0.317, 0.203),
              PageLabel("846", 0.37, 0.205),
              PageLabel("3588", 0.261, 0.216),
              PageLabel("2316", 0.278, 0.216),
              PageLabel("1166", 0.314, 0.216),
              PageLabel("3588", 0.361, 0.217),
              PageLabel("40", 0.388, 0.216),
              PageLabel("1401", 0.195, 0.228),
              PageLabel("846", 0.307, 0.228),
              PageLabel("3739", 0.338, 0.228),
              PageLabel("1163", 0.357, 0.229),
              PageLabel("1096", 0.276, 0.241),
              PageLabel("1722", 0.324, 0.24),
              PageLabel("5034", 0.357, 0.24),
              PageLabel("2532", 0.273, 0.253),
              PageLabel("4591", 0.326, 0.253),
              PageLabel("649", 0.3, 0.266),
              PageLabel("1223", 0.354, 0.266),
              PageLabel("3588", 0.385, 0.267),
              PageLabel("32", 0.287, 0.279),
              PageLabel("846", 0.351, 0.279),
              PageLabel("3588", 0.382, 0.28),
              PageLabel("1401", 0.281, 0.291),
              PageLabel("846", 0.342, 0.292),
              PageLabel("2491", 0.386, 0.292),
              PageLabel("3739", 0.295, 0.304),
              PageLabel("3140", 0.346, 0.304),
              PageLabel("3588", 0.301, 0.316),
              PageLabel("3056", 0.346, 0.317),
              PageLabel("3588", 0.381, 0.317),
              PageLabel("2316", 0.266, 0.329),
              PageLabel("2532", 0.29, 0.329),
              PageLabel("3588", 0.323, 0.33),
              PageLabel("3141", 0.379, 0.329),
              PageLabel("2424", 0.3, 0.343),
              PageLabel("5547", 0.322, 0.343),
              PageLabel("3745", 0.351, 0.342),
              PageLabel("1492", 0.38, 0.342),
              PageLabel("3107", 0.296, 0.353),
              PageLabel("3588", 0.333, 0.355),
              PageLabel("314", 0.283, 0.365),
              PageLabel("2532", 0.346, 0.366),
              PageLabel("3588", 0.366, 0.366),
              PageLabel("191", 0.295, 0.377),
              PageLabel("3588", 0.359, 0.378),
              PageLabel("3056", 0.271, 0.389),
              PageLabel("3588", 0.305, 0.389),
              PageLabel("4394", 0.353, 0.39),
              PageLabel("2532", 0.29, 0.401),
              PageLabel("5083", 0.348, 0.401),
              PageLabel("3588", 0.262, 0.412),
              PageLabel("1722", 0.283, 0.413),
              PageLabel("846", 0.318, 0.412),
              PageLabel("1125", 0.383, 0.413),
              PageLabel("3588", 0.31, 0.426),
              PageLabel("1063", 0.33, 0.425),
              PageLabel("2540", 0.363, 0.424),
              PageLabel("1451", 0.277, 0.437),
            ],
            words: [
              PageWord("ΑΠΟΚΑΛΥΨΙϹ", [
                PageRect(0.282, 0.121, 0.379, 0.139),
              ], sn: 602),
              PageWord("ΪΩΑΝΟΥ", [
                PageRect(0.388, 0.123, 0.444, 0.142),
              ], sn: 2491),
              PageWord("ΑΠΟΚΑΛΥΨΙϹ", [
              ...
              PageWord("ΕΔΩΚΕΝ", [
                PageRect(0.282, 0.203, 0.353, 0.214),
              ], sn: 1325),
              PageWord("ΑΥΤΩ", [PageRect(0.353, 0.204, 0.397, 0.216)], sn: 846),
              PageWord("Ο", [PageRect(0.256, 0.215, 0.267, 0.226)], sn: 3588),
              PageWord(
                "ΘϹ",
                [PageRect(0.268, 0.215, 0.288, 0.226)],
                sn: 2316,
                snTranslit: true,
              ),
              PageWord("ΔΕΙΞΑΙ", [
                PageRect(0.289, 0.215, 0.336, 0.226),
              ], sn: 1166),
              PageWord("ΤΟΙϹ", [
                PageRect(0.335, 0.216, 0.372, 0.227),
              ], sn: 3588),
              PageWord("ΑΓΙΟΙϹ", [
              ...
              PageWord("ΑΥΤΟΥ", [PageRect(0.281, 0.227, 0.331, 0.24)], sn: 846),
              PageWord("Α", [PageRect(0.331, 0.228, 0.342, 0.239)], sn: 3739),
              PageWord("ΔΕΙ", [PageRect(0.343, 0.228, 0.368, 0.239)], sn: 1163),
              PageWord("ΓΕΝΕϹΘΑΙ", [
                PageRect(0.37, 0.23, 0.39, 0.24),
                PageRect(0.256, 0.24, 0.314, 0.251),
              ], sn: 1096),
              PageWord("ΕΝ", [PageRect(0.315, 0.24, 0.337, 0.252)], sn: 1722),
              PageWord("ΤΑΧΕΙ", [
                PageRect(0.337, 0.241, 0.382, 0.252),
              ], sn: 5034),
              PageWord("ΚΑΙ", [PageRect(0.257, 0.253, 0.284, 0.264)], sn: 2532),
              PageWord("ΕϹΗΜΑΝΕΝ", [
                PageRect(0.283, 0.253, 0.379, 0.266),
              ], sn: 4591),
              PageWord("ΑΠΟϹΤΕΙΛΑϹ", [
                PageRect(0.378, 0.254, 0.393, 0.265),
                PageRect(0.255, 0.266, 0.342, 0.277),
              ], sn: 649),
              PageWord("ΔΙΑ", [PageRect(0.342, 0.266, 0.367, 0.278)], sn: 1223),
              PageWord("ΤΟΥ", [PageRect(0.367, 0.267, 0.393, 0.279)], sn: 3588),
              PageWord("ΑΓΓΕΛΟΥ", [
                PageRect(0.253, 0.278, 0.319, 0.291),
              ], sn: 32),
              PageWord("ΑΥΤΟΥ", [
                PageRect(0.319, 0.279, 0.375, 0.292),
              ], sn: 846),
              PageWord("ΤΩ", [PageRect(0.375, 0.28, 0.393, 0.291)], sn: 3588),
              PageWord("ΔΟΥΛΩ", [
                PageRect(0.254, 0.29, 0.308, 0.302),
              ], sn: 1401),
              PageWord("ΑΥΤΟΥ", [PageRect(0.308, 0.292, 0.36, 0.302)], sn: 846),
              PageWord("ΪΩΑΝΕΙ", [
                PageRect(0.361, 0.292, 0.397, 0.302),
                PageRect(0.256, 0.303, 0.283, 0.314),
              ], sn: 2491),
              PageWord("ΟϹ", [PageRect(0.284, 0.304, 0.305, 0.315)], sn: 3739),
              PageWord("ΕΜΑΡΤΥΡΗϹΕΝ", [
                PageRect(0.306, 0.305, 0.39, 0.315),
                PageRect(0.255, 0.316, 0.284, 0.326),
              ], sn: 3140),
              PageWord("ΤΟΝ", [PageRect(0.283, 0.315, 0.318, 0.327)], sn: 3588),
              PageWord("ΛΟΓΟΝ", [
                PageRect(0.318, 0.317, 0.368, 0.328),
              ], sn: 3056),
              PageWord("ΤΟΥ", [PageRect(0.368, 0.318, 0.391, 0.328)], sn: 3588),
              PageWord(
                "ΘΥ",
                [PageRect(0.253, 0.327, 0.275, 0.34)],
                sn: 2316,
                snTranslit: true,
              ),
              PageWord("ΚΑΙ", [PageRect(0.277, 0.329, 0.302, 0.34)], sn: 2532),
              PageWord("ΤΗΝ", [PageRect(0.302, 0.33, 0.34, 0.34)], sn: 3588),
              PageWord("ΜΑΡΤΥΡΙΑΝ", [
                PageRect(0.341, 0.329, 0.392, 0.34),
                PageRect(0.254, 0.341, 0.29, 0.353),
              ], sn: 3141),
              PageWord(
                "ΙΥ",
                [PageRect(0.291, 0.341, 0.309, 0.353)],
                sn: 2424,
                snTranslit: true,
              ),
              PageWord(
                "ΧΥ",
                [PageRect(0.309, 0.341, 0.334, 0.355)],
                sn: 5547,
                snTranslit: true,
              ),
              PageWord("ΟϹΑ", [PageRect(0.335, 0.341, 0.366, 0.353)], sn: 3745),
              PageWord("ΪΔΕ", [PageRect(0.367, 0.342, 0.392, 0.353)], sn: 1492),
              PageWord("ΜΑΚΑΡΙΟϹ", [
                PageRect(0.247, 0.354, 0.328, 0.366),
              ], sn: 3107),
              PageWord("Ο", [PageRect(0.328, 0.355, 0.339, 0.364)], sn: 3588),
              PageWord("ΑΝΑΓΙΝΩϹΚΩΝ", [
                PageRect(0.338, 0.354, 0.388, 0.365),
                PageRect(0.254, 0.365, 0.332, 0.376),
              ], sn: 314),
              PageWord("ΚΑΙ", [PageRect(0.332, 0.365, 0.358, 0.377)], sn: 2532),
              PageWord("ΟΙ", [PageRect(0.359, 0.366, 0.375, 0.378)], sn: 3588),
              PageWord("ΑΚΟΥΟΝΤΕϹ", [
                PageRect(0.375, 0.367, 0.389, 0.377),
                PageRect(0.252, 0.377, 0.342, 0.389),
              ], sn: 191),
              PageWord("ΤΟΝ", [PageRect(0.341, 0.378, 0.374, 0.389)], sn: 3588),
              PageWord("ΛΟΓΟΝ", [
                PageRect(0.374, 0.379, 0.389, 0.389),
                PageRect(0.254, 0.389, 0.287, 0.4),
              ], sn: 3056),
              PageWord("ΤΗϹ", [PageRect(0.286, 0.389, 0.321, 0.4)], sn: 3588),
              PageWord("ΠΡΟΦΗΤΙΑϹ", [
                PageRect(0.321, 0.389, 0.392, 0.402),
                PageRect(0.25, 0.4, 0.275, 0.41),
              ], sn: 4394),
              PageWord("ΚΑΙ", [PageRect(0.274, 0.401, 0.301, 0.411)], sn: 2532),
              PageWord("ΤΗΡΟΥΝΤΕϹ", [
                PageRect(0.3, 0.4, 0.388, 0.412),
              ], sn: 5083),
              PageWord("ΤΑ", [PageRect(0.248, 0.412, 0.272, 0.425)], sn: 3588),
              PageWord("ΕΝ", [PageRect(0.271, 0.412, 0.294, 0.424)], sn: 1722),
              PageWord("ΑΥΤΗ", [PageRect(0.295, 0.412, 0.34, 0.423)], sn: 846),
              PageWord("ΓΕΓΡΑΜΜΕΝΑ", [
                PageRect(0.34, 0.412, 0.404, 0.425),
                PageRect(0.253, 0.425, 0.303, 0.436),
              ], sn: 1125),
              PageWord("Ο", [PageRect(0.304, 0.425, 0.316, 0.437)], sn: 3588),
              PageWord("ΓΑΡ", [PageRect(0.315, 0.425, 0.344, 0.438)], sn: 1063),
              PageWord("ΚΑΙΡΟϹ", [
                PageRect(0.344, 0.425, 0.389, 0.439),
              ], sn: 2540),
              PageWord("ΕΓΓΥϹ", [
                PageRect(0.253, 0.437, 0.302, 0.449),
              ], sn: 1451),
            ],
          ),
          model.Page(
      ...
      PrimarySource(
        ...
        pages: [
          model.Page(
            ...
            wordSeparators: [
              PageLine(0.122, 0.158, 0.122, 0.171),
              PageLine(0.242, 0.158, 0.242, 0.171),
              PageLine(0.262, 0.158, 0.262, 0.171),
              PageLine(0.290, 0.158, 0.290, 0.171),
              PageLine(0.323, 0.158, 0.323, 0.171),
              PageLine(0.413, 0.158, 0.413, 0.171),
              PageLine(0.456, 0.158, 0.456, 0.171),
              PageLine(0.141, 0.173, 0.141, 0.183),
              PageLine(0.2, 0.173, 0.2, 0.183),
              PageLine(0.242, 0.173, 0.242, 0.183),
              PageLine(0.317, 0.173, 0.317, 0.183),
              PageLine(0.379, 0.173, 0.379, 0.183),
              PageLine(0.391, 0.173, 0.391, 0.183),
              PageLine(0.42, 0.173, 0.42, 0.183),
              PageLine(0.174, 0.183, 0.174, 0.193),
              PageLine(0.202, 0.183, 0.202, 0.193),
              PageLine(0.263, 0.183, 0.263, 0.193),
              PageLine(0.298, 0.183, 0.298, 0.193),
              PageLine(0.407, 0.184, 0.407, 0.194),
              PageLine(0.179, 0.194, 0.179, 0.204),
              PageLine(0.21, 0.194, 0.21, 0.204),
              PageLine(0.246, 0.195, 0.246, 0.205),
              PageLine(0.319, 0.195, 0.319, 0.205),
              PageLine(0.374, 0.196, 0.374, 0.206),
              PageLine(0.405, 0.196, 0.405, 0.206),
              PageLine(0.455, 0.196, 0.455, 0.206),
              PageLine(0.110, 0.206, 0.110, 0.216),
              PageLine(0.16, 0.206, 0.16, 0.216),
              PageLine(0.246, 0.206, 0.246, 0.216),
              PageLine(0.272, 0.206, 0.272, 0.216),
              PageLine(0.410, 0.206, 0.410, 0.216),
              PageLine(0.449, 0.206, 0.449, 0.216),
              PageLine(0.107, 0.216, 0.107, 0.226),
              PageLine(0.158, 0.216, 0.158, 0.226),
              PageLine(0.199, 0.216, 0.199, 0.226),
              PageLine(0.227, 0.216, 0.227, 0.226),
              PageLine(0.259, 0.216, 0.259, 0.226),
              PageLine(0.302, 0.217, 0.302, 0.227),
              PageLine(0.41, 0.217, 0.41, 0.227),
              PageLine(0.427, 0.217, 0.427, 0.227),
              PageLine(0.449, 0.217, 0.449, 0.227),
              PageLine(0.105, 0.226, 0.105, 0.236),
              PageLine(0.137, 0.226, 0.137, 0.236),
              PageLine(0.187, 0.226, 0.187, 0.236),
              PageLine(0.288, 0.226, 0.288, 0.236),
              PageLine(0.302, 0.226, 0.302, 0.236),
              PageLine(0.447, 0.228, 0.447, 0.238),
              PageLine(0.103, 0.237, 0.103, 0.247),
              PageLine(0.13, 0.237, 0.13, 0.247),
              PageLine(0.152, 0.237, 0.152, 0.247),
              PageLine(0.275, 0.237, 0.275, 0.247),
              PageLine(0.324, 0.237, 0.324, 0.247),
              PageLine(0.394, 0.238, 0.394, 0.248),
              PageLine(0.436, 0.238, 0.436, 0.248),
              PageLine(0.103, 0.247, 0.103, 0.257),
              PageLine(0.235, 0.247, 0.235, 0.257),
              PageLine(0.269, 0.248, 0.269, 0.258),
              PageLine(0.394, 0.248, 0.394, 0.258),
              PageLine(0.413, 0.248, 0.413, 0.258),
              PageLine(0.436, 0.248, 0.436, 0.258),
              PageLine(0.124, 0.256, 0.124, 0.266),
              PageLine(0.257, 0.258, 0.257, 0.268),
              PageLine(0.271, 0.259, 0.271, 0.269),
              PageLine(0.305, 0.259, 0.305, 0.269),
              PageLine(0.371, 0.259, 0.371, 0.27),
              PageLine(0.43, 0.259, 0.43, 0.27),
            ],
            strongNumbers: [
              PageLabel("602", 0.201, 0.16),
              PageLabel("2424", 0.253, 0.16),
              PageLabel("5547", 0.276, 0.16),
              PageLabel("3739", 0.307, 0.16),
              PageLabel("1325", 0.371, 0.161),
              PageLabel("846", 0.432, 0.162),
              PageLabel("1166", 0.173, 0.173),
              PageLabel("3588", 0.222, 0.173),
              PageLabel("1401", 0.285, 0.173),
              PageLabel("846", 0.348, 0.174),
              PageLabel("3739", 0.385, 0.174),
              PageLabel("1163", 0.405, 0.174),
              PageLabel("1096", 0.151, 0.184),
              PageLabel("1722", 0.188, 0.184),
              PageLabel("5034", 0.231, 0.184),
              PageLabel("2532", 0.282, 0.184),
              PageLabel("4591", 0.352, 0.185),
              PageLabel("649", 0.147, 0.195),
              PageLabel("1223", 0.196, 0.195),
              PageLabel("3588", 0.229, 0.196),
              PageLabel("32", 0.283, 0.196),
              PageLabel("846", 0.347, 0.197),
              PageLabel("3588", 0.39, 0.197),
              PageLabel("1401", 0.429, 0.197),
              PageLabel("846", 0.143, 0.205),
              PageLabel("2491", 0.204, 0.206),
              PageLabel("3739", 0.259, 0.206),
              PageLabel("3140", 0.344, 0.207),
              PageLabel("3588", 0.429, 0.208),
              PageLabel("3056", 0.133, 0.216),
              PageLabel("3588", 0.18, 0.216),
              PageLabel("2316", 0.212, 0.216),
              PageLabel("2532", 0.24, 0.216),
              PageLabel("3588", 0.284, 0.217),
              PageLabel("3141", 0.357, 0.218),
              PageLabel("2424", 0.418, 0.218),
              PageLabel("5547", 0.44, 0.218),
              PageLabel("3745", 0.123, 0.225),
              PageLabel("1492", 0.167, 0.226),
              PageLabel("3107", 0.246, 0.227),
              PageLabel("3588", 0.295, 0.227),
              PageLabel("314", 0.368, 0.229),
              PageLabel("2532", 0.12, 0.236),
              PageLabel("3588", 0.144, 0.237),
              PageLabel("191", 0.211, 0.237),
              PageLabel("3588", 0.302, 0.238),
              PageLabel("3056", 0.358, 0.239),
              PageLabel("3588", 0.414, 0.239),
              PageLabel("4394", 0.17, 0.248),
              PageLabel("2532", 0.253, 0.248),
              PageLabel("5083", 0.338, 0.249),
              PageLabel("3588", 0.403, 0.249),
              PageLabel("1722", 0.425, 0.249),
              PageLabel("846", 0.447, 0.249),
              PageLabel("1125", 0.199, 0.259),
              PageLabel("3588", 0.264, 0.259),
              PageLabel("1063", 0.286, 0.259),
              PageLabel("2540", 0.337, 0.259),
              PageLabel("1451", 0.401, 0.260),
            ],
            words: [
              PageWord(
                "ΑΠΟΚΑΛΥΨΙϹ",
                [PageRect(0.122, 0.158, 0.243, 0.172)],
                notExist: [0, 1, 2],
                sn: 602,
              ),
              PageWord(
                "ΙΥ",
                [PageRect(0.242, 0.158, 0.264, 0.172)],
                sn: 2424,
                snTranslit: true,
              ),
              PageWord(
                "ΧΥ",
                [PageRect(0.263, 0.158, 0.293, 0.172)],
                sn: 5547,
                snTranslit: true,
              ),
              PageWord("ΗΝ", [PageRect(0.291, 0.158, 0.323, 0.172)], sn: 3739),
              PageWord("ΕΔΩΚΕΝ", [
                PageRect(0.322, 0.159, 0.414, 0.172),
              ], sn: 1325),
              PageWord("ΑΥΤΩ", [PageRect(0.413, 0.158, 0.455, 0.173)], sn: 846),
              PageWord("ΔΕΙΞΑΙ", [
                PageRect(0.141, 0.171, 0.199, 0.184),
              ], sn: 1166),
              PageWord("ΤΟΙϹ", [
                PageRect(0.199, 0.172, 0.243, 0.183),
              ], sn: 3588),
              PageWord("ΔΟΥΛΟΙϹ", [
                PageRect(0.243, 0.172, 0.317, 0.184),
              ], sn: 1401),
              PageWord("ΑΥΤΟΥ", [
                PageRect(0.317, 0.173, 0.381, 0.186),
              ], sn: 846),
              PageWord("Α", [PageRect(0.38, 0.173, 0.391, 0.184)], sn: 3739),
              PageWord("ΔΕΙ", [PageRect(0.389, 0.173, 0.419, 0.185)], sn: 1163),
              PageWord(
                "ΓΕΝΕϹΘΑΙ",
                [
                  PageRect(0.421, 0.175, 0.445, 0.184),
                  PageRect(0.121, 0.184, 0.175, 0.193),
                ],
                notExist: [2, 3, 4],
                sn: 1096,
              ),
              PageWord("ΕΝ", [PageRect(0.175, 0.183, 0.202, 0.195)], sn: 1722),
              PageWord("ΤΑΧΕΙ", [
                PageRect(0.202, 0.184, 0.262, 0.195),
              ], sn: 5034),
              PageWord("ΚΑΙ", [PageRect(0.266, 0.184, 0.299, 0.194)], sn: 2532),
              PageWord("ΕϹΗΜΑΝΕΝ", [
                PageRect(0.299, 0.184, 0.408, 0.196),
              ], sn: 4591),
              PageWord(
                "ΑΠΟϹΤΕΙΛΑϹ",
                [
                  PageRect(0.408, 0.185, 0.446, 0.195),
                  PageRect(0.113, 0.194, 0.181, 0.205),
                ],
                notExist: [3, 4],
                sn: 649,
              ),
              PageWord("ΔΙΑ", [PageRect(0.18, 0.195, 0.211, 0.204)], sn: 1223),
              PageWord("ΤΟΥ", [PageRect(0.21, 0.195, 0.247, 0.206)], sn: 3588),
              PageWord("ΑΓΓΕΛΟΥ", [
                PageRect(0.247, 0.195, 0.319, 0.205),
              ], sn: 32),
              PageWord("ΑΥΤΟΥ", [PageRect(0.32, 0.196, 0.374, 0.205)], sn: 846),
              PageWord("ΤΟΥ", [PageRect(0.374, 0.196, 0.406, 0.206)], sn: 3588),
              PageWord("ΔΟΥΛΟΥ", [
                PageRect(0.406, 0.197, 0.453, 0.205),
              ], sn: 1401),
              PageWord(
                "ΑΥΤΟΥ",
                [PageRect(0.11, 0.206, 0.161, 0.215)],
                notExist: [0, 1],
                sn: 846,
              ),
              PageWord("ΙΩΑΝΝΗ", [
                PageRect(0.16, 0.206, 0.243, 0.215),
              ], sn: 2491),
              PageWord("ΟϹ", [PageRect(0.247, 0.206, 0.273, 0.215)], sn: 3739),
              PageWord("ΕΜΑΡΤΥΡΗϹΕΝ", [
                PageRect(0.273, 0.206, 0.409, 0.217),
              ], sn: 3140),
              PageWord("ΤΟΝ", [PageRect(0.409, 0.208, 0.447, 0.217)], sn: 3588),
              PageWord(
                "ΛΟΓΟΝ",
                [PageRect(0.108, 0.215, 0.159, 0.224)],
                notExist: [0, 1],
                sn: 3056,
              ),
              PageWord("ΤΟΥ", [PageRect(0.159, 0.216, 0.2, 0.225)], sn: 3588),
              PageWord(
                "ΘΥ",
                [PageRect(0.199, 0.216, 0.227, 0.226)],
                sn: 2316,
                snTranslit: true,
              ),
              PageWord("ΚΑΙ", [PageRect(0.227, 0.217, 0.259, 0.225)], sn: 2532),
              PageWord("ΤΗΝ", [PageRect(0.259, 0.217, 0.302, 0.226)], sn: 3588),
              PageWord("ΜΑΡΤΥΡΙΑΝ", [
                PageRect(0.302, 0.218, 0.41, 0.228),
              ], sn: 3141),
              PageWord(
                "ΙΥ",
                [PageRect(0.411, 0.218, 0.429, 0.228)],
                sn: 2424,
                snTranslit: true,
              ),
              PageWord(
                "ΧΥ",
                [PageRect(0.428, 0.218, 0.449, 0.228)],
                sn: 5547,
                snTranslit: true,
              ),
              PageWord(
                "ΟϹΑ",
                [PageRect(0.106, 0.225, 0.138, 0.235)],
                notExist: [0],
                sn: 3745,
              ),
              PageWord("ΙΔΕΝ", [
                PageRect(0.138, 0.224, 0.186, 0.236),
              ], sn: 1492),
              PageWord("ΜΑΚΑΡΙΟϹ", [
                PageRect(0.185, 0.227, 0.288, 0.237),
              ], sn: 3107),
              PageWord("Ο", [PageRect(0.288, 0.227, 0.302, 0.237)], sn: 3588),
              PageWord("ΑΝΑΓΙΝΩϹΚΩΝ", [
                PageRect(0.303, 0.227, 0.448, 0.238),
              ], sn: 314),
              PageWord(
                "ΚΑΙ",
                [PageRect(0.105, 0.236, 0.131, 0.246)],
                notExist: [0],
                sn: 2532,
              ),
              PageWord("ΟΙ", [PageRect(0.132, 0.237, 0.152, 0.246)], sn: 3588),
              PageWord("ΑΚΟΥΟΝΤΕϹ", [
                PageRect(0.152, 0.237, 0.276, 0.247),
              ], sn: 191),
              PageWord("ΤΟΥϹ", [
                PageRect(0.276, 0.237, 0.325, 0.248),
              ], sn: 3588),
              PageWord("ΛΟΓΟΥϹ", [
                PageRect(0.325, 0.238, 0.395, 0.249),
              ], sn: 3056),
              PageWord("ΤΗϹ", [PageRect(0.396, 0.239, 0.436, 0.247)], sn: 3588),
              PageWord(
                "ΠΡΟΦΗΤΕΙΑϹ",
                [PageRect(0.103, 0.247, 0.234, 0.257)],
                notExist: [0],
                sn: 4394,
              ),
              PageWord("ΚΑΙ", [PageRect(0.235, 0.248, 0.27, 0.257)], sn: 2532),
              PageWord("ΤΗΡΟΥΝΤΕϹ", [
                PageRect(0.268, 0.249, 0.393, 0.259),
              ], sn: 5083),
              PageWord("ΤΑ", [PageRect(0.393, 0.249, 0.415, 0.257)], sn: 3588),
              PageWord("ΕΝ", [PageRect(0.412, 0.25, 0.436, 0.258)], sn: 1722),
              PageWord("ΑΥΤΗ", [
                PageRect(0.436, 0.25, 0.45, 0.257),
                PageRect(0.105, 0.257, 0.125, 0.266),
              ], sn: 846),
              PageWord("ΓΕΓΡΑΜΜΕΝΑ", [
                PageRect(0.125, 0.257, 0.257, 0.268),
              ], sn: 1125),
              PageWord("Ο", [PageRect(0.258, 0.259, 0.272, 0.267)], sn: 3588),
              PageWord("ΓΑΡ", [PageRect(0.271, 0.26, 0.305, 0.268)], sn: 1063),
              PageWord("ΚΑΙΡΟϹ", [
      ...
      PrimarySource(
        ...
        pages: [
          model.Page(
            ...
            wordSeparators: [
              PageLine(0.107, 0.165, 0.107, 0.182),
              PageLine(0.154, 0.168, 0.154, 0.184),
              PageLine(0.343, 0.173, 0.343, 0.187),
              PageLine(0.4, 0.173, 0.4, 0.187),
              PageLine(0.486, 0.178, 0.486, 0.192),
              PageLine(0.538, 0.178, 0.538, 0.194),
              PageLine(0.575, 0.179, 0.575, 0.195),
              PageLine(0.678, 0.181, 0.678, 0.195),
              PageLine(0.826, 0.181, 0.826, 0.197),
              PageLine(0.126, 0.184, 0.126, 0.2),
              PageLine(0.154, 0.184, 0.154, 0.2),
              PageLine(0.191, 0.186, 0.191, 0.2),
              PageLine(0.24, 0.186, 0.24, 0.2),
              PageLine(0.325, 0.19, 0.325, 0.200),
              PageLine(0.455, 0.196, 0.455, 0.206),
              PageLine(0.474, 0.195, 0.474, 0.207),
              PageLine(0.661, 0.199, 0.661, 0.21),
              PageLine(0.705, 0.199, 0.705, 0.21),
              PageLine(0.73, 0.199, 0.73, 0.211),
              PageLine(0.179, 0.2, 0.179, 0.216),
              PageLine(0.251, 0.202, 0.251, 0.217),
              PageLine(0.353, 0.207, 0.353, 0.217),
              PageLine(0.481, 0.210, 0.481, 0.224),
              PageLine(0.532, 0.21, 0.532, 0.225),
              PageLine(0.7, 0.215, 0.7, 0.228),
              PageLine(0.749, 0.215, 0.749, 0.228),
              PageLine(0.178, 0.218, 0.178, 0.232),
              PageLine(0.215, 0.218, 0.215, 0.232),
              PageLine(0.25, 0.219, 0.25, 0.233),
              PageLine(0.317, 0.222, 0.317, 0.236),
              PageLine(0.482, 0.228, 0.482, 0.241),
              PageLine(0.496, 0.228, 0.496, 0.241),
              PageLine(0.538, 0.228, 0.538, 0.245),
              PageLine(0.629, 0.228, 0.629, 0.245),
              PageLine(0.75, 0.229, 0.75, 0.245),
            ],
            strongNumbers: [
              PageLabel("3739", 0.14, 0.168),
              PageLabel("3140", 0.257, 0.171),
              PageLabel("3588", 0.373, 0.174),
              PageLabel("3056", 0.447, 0.178),
              PageLabel("3588", 0.513, 0.18),
              PageLabel("2316", 0.559, 0.18),
              PageLabel("?", 0.63, 0.179),
              PageLabel("3141", 0.762, 0.182),
              PageLabel("2424", 0.142, 0.185),
              PageLabel("5547", 0.172, 0.185),
              PageLabel("3745", 0.217, 0.185),
              PageLabel("1492", 0.291, 0.187),
              PageLabel("3107", 0.391, 0.192),
              PageLabel("3588", 0.464, 0.195),
              PageLabel("314", 0.573, 0.198),
              PageLabel("2532", 0.684, 0.199),
              PageLabel("3588", 0.718, 0.199),
              PageLabel("191", 0.792, 0.2),
              PageLabel("3588", 0.22, 0.203),
              PageLabel("3056", 0.312, 0.204),
              PageLabel("5128", 0.421, 0.208),
              PageLabel("3588", 0.509, 0.21),
              PageLabel("4394", 0.631, 0.214),
              PageLabel("2532", 0.727, 0.215),
              PageLabel("5083", 0.811, 0.216),
              PageLabel("3588", 0.198, 0.22),
              PageLabel("1722", 0.232, 0.22),
              PageLabel("846", 0.285, 0.221),
              PageLabel("1125", 0.407, 0.225),
              PageLabel("3588", 0.489, 0.228),
              PageLabel("1063", 0.518, 0.229),
              PageLabel("2540", 0.592, 0.230),
              PageLabel("?", 0.691, 0.23),
            ],
            words: [
              PageWord("ΟϹ", [PageRect(0.109, 0.165, 0.154, 0.182)], sn: 3739),
              PageWord("ΕΜΑΡΤΥΡΗϹΕΝ", [
                PageRect(0.155, 0.17, 0.344, 0.186),
              ], sn: 3140),
              PageWord("ΤΟΝ", [PageRect(0.343, 0.174, 0.4, 0.188)], sn: 3588),
              PageWord("ΛΟΓΟΝ", [PageRect(0.4, 0.177, 0.485, 0.192)], sn: 3056),
              PageWord("ΤΟΥ", [PageRect(0.488, 0.18, 0.538, 0.194)], sn: 3588),
              PageWord(
                "ΘΥ",
                [PageRect(0.541, 0.18, 0.574, 0.196)],
                sn: 2316,
                snTranslit: true,
              ),
              PageWord("?", [PageRect(0.578, 0.18, 0.677, 0.196)]),
              PageWord(
                "ΜΑΡΤΥΡΙΑΝ",
                [PageRect(0.68, 0.181, 0.826, 0.198)],
                notExist: [0, 1, 2],
                sn: 3141,
              ),
              PageWord(
              ...
              PageWord(
                "ΧΥ",
                [PageRect(0.156, 0.187, 0.19, 0.198)],
                sn: 5547,
                snTranslit: true,
              ),
              PageWord("ΟϹΑ", [PageRect(0.191, 0.185, 0.239, 0.2)], sn: 3745),
              PageWord("ΕΙΔΕΝ", [
                PageRect(0.24, 0.187, 0.323, 0.201),
              ], sn: 1492),
              PageWord("ΜΑΚΑΡΙΟϹ", [
                PageRect(0.326, 0.192, 0.455, 0.205),
              ], sn: 3107),
              PageWord("Ο", [PageRect(0.457, 0.196, 0.473, 0.207)], sn: 3588),
              PageWord("ΑΝΑΓΙΝΩϹΚΩΝ", [
                PageRect(0.475, 0.197, 0.66, 0.211),
              ], sn: 314),
              PageWord("ΚΑΙ", [PageRect(0.663, 0.199, 0.705, 0.211)], sn: 2532),
              PageWord("ΟΙ", [PageRect(0.706, 0.201, 0.729, 0.211)], sn: 3588),
              PageWord("ΑΚΟΥΟΝΤΕϹ", [
                PageRect(0.728, 0.2, 0.818, 0.213),
                PageRect(0.123, 0.199, 0.179, 0.215),
              ], sn: 191),
              PageWord("ΤΟΥϹ", [
                PageRect(0.183, 0.201, 0.254, 0.218),
              ], sn: 3588),
              PageWord(
                "ΛΟΓΟΥϹ",
                [PageRect(0.253, 0.204, 0.356, 0.218)],
                notExist: [3, 4],
                sn: 3056,
              ),
              PageWord("ΤΟΥΤΟΥϹ", [
                PageRect(0.353, 0.207, 0.481, 0.222),
              ], sn: 5128),
              PageWord("ΤΗϹ", [PageRect(0.482, 0.212, 0.536, 0.224)], sn: 3588),
              PageWord("ΠΡΟΦΗΤΙΑϹ", [
                PageRect(0.535, 0.213, 0.7, 0.229),
              ], sn: 4394),
              PageWord("ΚΑΙ", [PageRect(0.702, 0.217, 0.747, 0.227)], sn: 2532),
              PageWord(
                "ΤΗΡΟΥΝΤΕϹ",
                [
                  PageRect(0.749, 0.217, 0.823, 0.228),
                  PageRect(0.123, 0.219, 0.177, 0.232),
                ],
                notExist: [5],
                sn: 5083,
              ),
              PageWord("ΤΑ", [PageRect(0.179, 0.22, 0.214, 0.233)], sn: 3588),
              PageWord("ΕΝ", [PageRect(0.215, 0.219, 0.248, 0.233)], sn: 1722),
              PageWord("ΑΥΤΗ", [PageRect(0.25, 0.221, 0.316, 0.235)], sn: 846),
              PageWord(
                "ΓΕΓΡΑΜΜΕΝΑ",
                [PageRect(0.317, 0.224, 0.481, 0.239)],
                notExist: [9],
                sn: 1125,
              ),
              PageWord("Ο", [PageRect(0.482, 0.229, 0.495, 0.241)], sn: 3588),
              PageWord(
                "ΓΑΡ",
                [PageRect(0.496, 0.228, 0.538, 0.246)],
                notExist: [0],
                sn: 1063,
              ),
              PageWord(
                "ΚΑΙΡΟϹ",
                [PageRect(0.539, 0.229, 0.629, 0.245)],
                notExist: [2],
                sn: 2540,
              ),
              PageWord("?", [PageRect(0.628, 0.229, 0.748, 0.244)]),
            ],
          ),
          model.Page(
            name: "197v",
