...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get uncial_01_material => 'Синайский кодекс написан на пергаменте (vellum), преимущественно из телячьей кожи (с использованием овечьей кожи в меньшей степени). Изначально он создавался из двойных листов, предположительно размером около 40 × 70 см; часть, хранящаяся в Британской библиотеке, состоит из 346½ фолио (694 страницы) размером примерно 38,1 × 34,5 см.';

  @override
  String get uncial_01_textStyle => 'Рукопись выполнена в формальном унциальном почерке (библейская майскюль) на греческом языке, с использованием scriptio continua (без пробелов между словами). Текст расположен в колонках (четыре колонки на страницу для Нового Завета и две для поэтических текстов), с тщательно выверенными разрывами строк, nomina sacra и специфической пунктуацией.';
  ...
  @override
  String get uncial_01_classification => 'С точки зрения текстологии, Синайский кодекс относится к александрийскому типу текста и классифицируется как Категория I для рукописей Нового Завета.';

  @override
  String get uncial_01_currentLocation => 'В настоящее время части кодекса хранятся в нескольких учреждениях: преимущественно в Британской библиотеке (Лондон), а также в Библиотеке Лейпцигского университета, монастыре Святой Екатерины (Синай) и Российской национальной библиотеке (Санкт-Петербург).';
