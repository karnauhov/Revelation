...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get papyrus_115_textStyle => 'Текст написан греческим унциальным письмом, расположен в одну колонку на странице с 33-36 строками в колонке. Он следует стилю scriptio continua без разделения слов и содержит отдельные знаки пунктуации и сокращения, характерные для библейских рукописей того периода.';

  @override
  String get papyrus_115_found => 'Папирус 115 был обнаружен в Оксиринхе, Египет, учеными Бернардом Пайном Гренфеллом и Артуром Хантом в конце XIX или начале XX века, хотя он не был расшифрован и опубликован до конца XX века.';
