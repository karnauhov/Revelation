...
class RevelationMarkdownYoutubeBlockSyntax extends md.BlockSyntax {
  const RevelationMarkdownYoutubeBlockSyntax();

  static const String blockName = 'youtube';
  static final RegExp _openingPattern = RegExp(r'^\s*\{\{youtube\}\}\s*$');
  static final RegExp _closingPattern = RegExp(r'^\s*\{\{\/youtube\}\}\s*$');
