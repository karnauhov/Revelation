...
- Privacy Policy и лицензию сделать в формате md и встроить как ассеты в приложение и сделать их локализованными и открывать в отдельном окне (все как для topics)
