...
- Дополнить предисловие про выбор перечня первоисточников:
  - Бог управляет тем какие источники книги Откровение и в каком объеме должны сохранится чтобы быть свидетельстовом. Тексты об этом.
  - Предупреждение Бога о том что нельзя ничего дополнять, изменять и убирать из книги Откровение. Тексты об этом.
  - Почему выбрано использовать унциалы и папирусы для создания единого текста книги Откровение
