...
- [ ] Добавить редактор локализованных текстов для текущей выбранной БД
- [ ] Добавить редактор ссылок
- [ ] Добавить редактор атрибуции/rights
- [ ] Добавить редактор страниц
- [ ] Добавить редактор слов для выбранной страницы
- [ ] Добавить редактор стихов для выбранной страницы
- [ ] Добавить потоки сохранения/удаления с согласованной записью в common и
      localized БД
- [ ] Добавить validation warnings для дублирующихся IDs, дублирующихся page
